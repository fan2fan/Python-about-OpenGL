...
# Initial a 3D array 46*2D Array(46*3)
...
def InitGL(Width, Height):                 # We call this right after our OpenGL window is created.
	...
	#GL_FILL stands for th back is filled
	glPolygonMode(GL_BACK,GL_FILL)
    #GL_LINE stands for the front is linear
...
def DrawGLScene():
	...
	for x in xrange(45):
		for y in xrange(45):
			...
			# notice: the when x equals to 44, the quad turns to a line
            # so totally there are only 44 quads
			# bottom left
	...
	if w_count==2: # for slowing the wave
		for y in xrange(45): # walk on plane Y
			...
			points[44][y][2]=hold # make it mobile in a circle 
		w_count = 1
	w_count+=1
...
# append-- the array of points:
# [[[-4.5        -4.5         0.        ]
# [-4.5        -4.30000019  0.        ]
# [-4.5        -4.0999999   0.        ]
# ...,(there are 40 vectors between & they are odd symmetrical  ) 
# [-4.5         4.0999999   0.        ]
# [-4.5         4.30000019  0.        ]
# [ 0.          0.          0.        ]]
#
# [[-4.30000019 -4.5         0.13917311]
# [-4.30000019 -4.30000019  0.13917311]
# [-4.30000019 -4.0999999   0.13917311]
# ...,(there are 40 vectors between & they are odd symmetrical  )
# [-4.30000019  4.0999999   0.13917311]
# [-4.30000019  4.30000019  0.13917311]
# [ 0.          0.          0.        ]]

# [[-4.0999999  -4.5         0.27563736]
# [-4.0999999  -4.30000019  0.27563736]
# [-4.0999999  -4.0999999   0.27563736]
# ...,(there are 40 vectors between & they are odd symmetrical  )
# [-4.0999999   4.0999999   0.27563736]
# [-4.0999999   4.30000019  0.27563736]
# [ 0.          0.          0.        ]]
# 
#  ...,(there are 40 2D_Array between & they are odd symmetrical  )
# [[ 4.0999999  -4.5        -0.27563736]
#  [ 4.0999999  -4.30000019 -0.27563736]
#  [ 4.0999999  -4.0999999  -0.27563736]
#  ...,(there are 40 vectors between & they are odd symmetrical  ) 
