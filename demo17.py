...
def Update ():
	...
	if (done):															# // If done Is True Then There Were No Unvisited Rooms
		...
		glutSetWindowTitle ("Multiple Viewports... Maze Complete!");
		time.sleep (5)
		glutSetWindowTitle ("Multiple Viewports... Building Maze!");
		Reset();
...
def main():
	...
	window = glutCreateWindow("Multiple Viewports... Building Maze!");
