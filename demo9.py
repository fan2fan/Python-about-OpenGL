...
def InitGL(Width, Height):                # We call this right after our OpenGL window is created.
    ...
    # stands for the quality of color and texture coord
	# GL_NICEST the  best-quality
	# GL_FASTEST the most efficient
    # GL_DONT_CARE no user preference
...
def DrawGLScene():
    ...
    # and the length of a side is 2!!!!
	glNewList(box,GL_COMPILE)
	# upper face are not create
	glBegin(GL_QUADS);
